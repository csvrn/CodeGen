const CreateFilter = (pageName, fields, screenInfo, tools) => {
  let imports = `Code template with necessary modificaitons.`;
  ...
  for (const [key, value] of Object.entries(fields)) {
    if (value.visibleScreens && value.visibleScreens.includes("Filter Page")) {
